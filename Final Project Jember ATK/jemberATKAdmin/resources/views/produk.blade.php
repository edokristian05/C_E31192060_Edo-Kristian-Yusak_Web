                ...
                @foreach($listUser as $data)
                    <tr>
                        ...
                        <a href="{{route('produk.edit', [$data->id])}}">
                            <i class="btn btn-warning btn btn-sm">Edit</i>
                        </a>
              ...
              <form method="POST" action="{{ route('produk.store') }}" role="form" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Harga nameset..." name="harga_nameset">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" placeholder="Deskripsi ..." name="jenis"></textarea>
                  </div>
