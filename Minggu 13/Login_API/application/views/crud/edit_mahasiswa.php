<div class="row">
    <div class="col-lg-7">
        <div class="p-5">
            <div class="text-center">
                ...
                <form class="user" action="<?php echo base_url('Mahasiswa/update'); ?>" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-user" id="username" name="username" placeholder="Username Maximal 10 Character" value="<?php echo
                                                                                                                                                                    $baris->username; ?>" require>
                    </div>
                    <div class="form-group">
            ...
            <hr>
            <div class="text-center"><a class="small" href="<?php echo base_url('Mahasiswa')
                                                            ?>">Kembali</a>
            </div>
        </div>
    </div>
